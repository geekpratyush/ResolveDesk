...
dotnet add src/ResolveDesk.Services.TicketCore/ResolveDesk.Services.TicketCore.csproj package MassTransit.RabbitMQ --version 8.2.5
...
echo "Installing Notification Service NuGet packages (NET 8 compatible)..."
dotnet add src/ResolveDesk.Services.Notification/ResolveDesk.Services.Notification.csproj package MassTransit --version 8.2.5
dotnet add src/ResolveDesk.Services.Notification/ResolveDesk.Services.Notification.csproj package MassTransit.RabbitMQ --version 8.2.5
